...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Privacy law meets AI systems." },
...
export const siteConfig: SiteConfig = {
  domain: "aiprivacy.report",
  url: "https://aiprivacy.report",
  title: "AI Privacy Report",
  tagline: "AI privacy regulation, compliance, and enforcement, sourced.",
  description:
  ...
  byline: "AI Privacy Report Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 30, cluster: "policy" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@aiprivacy.report",
    abuse: "abuse@aiprivacy.report",
    editor: "editor@aiprivacy.report",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "aiprivacy.report"),
  analytics: {},
};
